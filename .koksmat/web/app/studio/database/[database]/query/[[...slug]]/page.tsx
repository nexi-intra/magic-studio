...
function summarizeSQL(sql: string): string {
  ...
  // Try to capture the main table name, considering schema and quoted names
  // Match: schema.table, "schema"."table", "table", or table
  let tableMatch = sql.match(/(?:FROM|INTO|UPDATE)\s+((["`]?[\w]+["`]?\.)?["`]?[\w]+["`]?\b)/i);
  let tableName = tableMatch ? tableMatch[1].replace(/["`]/g, '') : 'Unknown Table';
