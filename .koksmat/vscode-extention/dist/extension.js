...
const vscode = __importStar(__webpack_require__(140));
const TreeDataProvider_1 = __webpack_require__(141);
class Logger {
    static channel;
    static log(message) {
        if (this.channel) {
...
function activate(context) {
    ...
    vscode.commands.registerCommand("demoTreeView.openFile", async (resource) => {
        ...
        vscode.window.showTextDocument(vscode.Uri.parse("/Users/nielsgregersjohansen/kitchens/magic-studio/.koksmat/vscode-extention/src/extension.ts"));
    });
    const refreshCommand = vscode.commands.registerCommand("koksmat.refreshTree", () => {
        treeDataProvider.refresh();
    });
    context.subscriptions.push(vscode.window.registerWebviewViewProvider("koksmatWebView", new WebviewViewProvider(context)));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.DemoTreeItem = exports.DemoTreeDataProvider = void 0;
const vscode = __importStar(__webpack_require__(140));
...
class DemoTreeItem extends vscode.TreeItem {
    children;
    filePath;
    constructor(label, filePath, children) {
